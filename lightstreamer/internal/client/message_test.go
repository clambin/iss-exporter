...
func TestParseSessionMessage(t *testing.T) {
	tests := []struct {
		...
		{name: "CONOK", line: "CONOK,sessionID,50000,5000,*", pass: true, want: Message{CONOKData{"sessionID", "*", 50000, 5000}, "CONOK"}},
		...
		{name: "CLIENTIP (too short)", line: "CLIENTIP", pass: false},
		{name: "NOOP", line: "NOOP,ignored text", pass: true, want: Message{NOOPData{Preamble: []string{"ignored text"}}, "NOOP"}},
		{name: "CONS (unlimited)", line: "CONS,unlimited", pass: true, want: Message{CONSData{math.Inf(1)}, "CONS"}},
		{name: "CONS (limited)", line: "CONS,5000", pass: true, want: Message{CONSData{5000}, "CONS"}},
		{name: "CONS (too short)", line: "CONS", pass: false},
		{name: "CONS (bad number)", line: "CONS,a", pass: false},
		...
		{name: "END", line: "END,10,done", pass: true, want: Message{ENDData{"done", 10}, "END"}},
		...
		{name: "SUBOK (invalid items)", line: "SUBOK,1,a,5", pass: false},
		{name: "SUBOK (invalid fields)", line: "SUBOK,1,1,a", pass: false},
		{name: "CONF (filtered)", line: "CONF,100,100,filtered", pass: true, want: Message{CONFData{100, 100, true}, "CONF"}},
		{name: "CONF (unfiltered)", line: "CONF,100,100,unfiltered", pass: true, want: Message{CONFData{100, 100, false}, "CONF"}},
		{name: "CONF (unlimited)", line: "CONF,100,unlimited,unfiltered", pass: true, want: Message{CONFData{100, math.Inf(1), false}, "CONF"}},
		{name: "CONF (too short)", line: "CONF", pass: false},
		{name: "CONF (invalid subscription ID)", line: "CONF,a,unlimited,unfiltered", pass: false},
		{name: "CONF (invalid bandwidth)", line: "CONF,100,a,unfiltered", pass: false},
		{name: "CONF (invalid filter)", line: "CONF,100,unlimited,a", pass: false},
...
func TestParseControlMessage(t *testing.T) {
	tests := []struct {
		...
		{name: "REQOK", line: "REQOK,1", pass: true, want: Message{REQOKData{1}, "REQOK"}},
		{name: "REQOK (too short)", line: "REQOK", pass: false},
		{name: "REQOK (invalid request ID)", line: "REQOK,a", pass: false},
		{name: "REQERR", line: "REQERR,1,10,error", pass: true, want: Message{REQERRData{"error", 1, 10}, "REQERR"}},
